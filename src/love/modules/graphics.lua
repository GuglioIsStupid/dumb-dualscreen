...
return {
	...
	rectangleBottom = function(mode,x,y,width,height)
		if x > 400 then
			x = x - 120
		elseif x < 100 then
			x = x + 120
		end
		love.graphics.rectangle(mode,x,y+bottomHeight,width,height)
	end,
